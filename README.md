...
后台还内置了按职责拆分的维护账号，默认密码和用户名相同：

```text
viewer / viewer                 # 只读
user-admin / user-admin         # 用户和 Realm Role 维护
policy-admin / policy-admin     # UMA Resource、Policy、Permission、系统接口权限维护
sync-admin / sync-admin         # 模型同步和扫描导入
```
...
PERMISSION_ADMIN_LOCAL_READONLY_USERNAME
PERMISSION_ADMIN_LOCAL_READONLY_PASSWORD
PERMISSION_ADMIN_LOCAL_USER_ADMIN_USERNAME
PERMISSION_ADMIN_LOCAL_USER_ADMIN_PASSWORD
PERMISSION_ADMIN_LOCAL_POLICY_ADMIN_USERNAME
PERMISSION_ADMIN_LOCAL_POLICY_ADMIN_PASSWORD
PERMISSION_ADMIN_LOCAL_SYNC_ADMIN_USERNAME
PERMISSION_ADMIN_LOCAL_SYNC_ADMIN_PASSWORD
PERMISSION_ADMIN_LOCAL_PORT
PERMISSION_ADMIN_LOCAL_DATA_FILE
PERMISSION_ADMIN_LOCAL_AUDIT_FILE
PERMISSION_ADMIN_KEYCLOAK_USERNAME
PERMISSION_ADMIN_KEYCLOAK_PASSWORD
PERMISSION_ADMIN_KEYCLOAK_READONLY_USERNAME
PERMISSION_ADMIN_KEYCLOAK_READONLY_PASSWORD
PERMISSION_ADMIN_KEYCLOAK_USER_ADMIN_USERNAME
PERMISSION_ADMIN_KEYCLOAK_USER_ADMIN_PASSWORD
PERMISSION_ADMIN_KEYCLOAK_POLICY_ADMIN_USERNAME
PERMISSION_ADMIN_KEYCLOAK_POLICY_ADMIN_PASSWORD
PERMISSION_ADMIN_KEYCLOAK_SYNC_ADMIN_USERNAME
PERMISSION_ADMIN_KEYCLOAK_SYNC_ADMIN_PASSWORD
PERMISSION_ADMIN_KEYCLOAK_AUDIT_FILE
```
...
写操作会记录 JSON Lines 审计日志，默认路径：

```text
admin/permission-admin-local/logs/permission-admin-local-audit.log
admin/permission-admin-keycloak/logs/permission-admin-keycloak-audit.log
```

每条审计日志包含操作时间、操作人、来源 IP、动作、目标、修改前模型和修改后模型。
